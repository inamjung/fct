...
class Pttype extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['pttype', 'pcode', 'paidst', 'fee_code_paidst', 'fee_code2_paidst', 'nhso_code', 'pttype_eclaim_id'], 'string', 'max' => 2],
            [['name'], 'string', 'max' => 250],
            [['editmask'], 'string', 'max' => 100],
            [['isuse', 'requirecode', 'doctor_fee', 'contract', 'in_region', 'uc', 'require_hcode', 'debtor', 'noexpire', 'bill_sss', 'use_contract_id', 'yearly_charge', 'allow_finance_edit', 'print_csmb_statement', 'rx_pay_debit_tr', 'separate_rcpno', 'separate_debt_id', 'use_package', 'charge_df_perday', 'print_presc_ned', 'export_eclaim', 'round_money', 'emp_privilege', 'is_pttype_plan', 'finance_round_money', 'emp_financial'], 'string', 'max' => 1],
    ...
    public function getPttypes(){
        return $this->hasMany(Fct::className(), ['pttype'=>'pttype']);
    }
}
