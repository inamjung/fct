...
/**
 * FcthhcdetailSearch represents the model behind the search form about `app\modules\fct\models\Fcthhcdetail`.
 */
class FcthhcdetailSearch extends Fcthhcdetail
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'fcthhc_id' => $this->fcthhc_id,
            'fct_id' => $this->fct_id,
            'fctnumber' => $this->fctnumber,
        ...
        $query->andFilterWhere(['like', 'homept', $this->homept])
