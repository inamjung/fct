...
class Fcthhcdetail extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['status'], 'string'],
            [['homept', 'hearta', 'heartnote', 'sociala', 'socialnote', 'other2', 'deg04', 'deg15', 'deg14', 'deg13', 'deg12', 'deg11', 'deg09', 'deg08', 'deg07', 'deg06', 'deg05', 'deg03', 'deg02', 'deg01', 'fctname6', 'departfct', 'lr01', 'lr03', 'lr05', 'lrl08', 'lr', 'lrl09'], 'string', 'max' => 100],
            [['t', 'pr', 'rr'], 'string', 'max' => 5],
            [['bp'], 'string', 'max' => 7],
            [['feel', 'self', 'sore', 'fctname1', 'fctname2', 'fctname3', 'fctname4', 'fctname5','dc'], 'string', 'max' => 20],
            [['eat','child614_food'], 'string', 'max' => 50],
