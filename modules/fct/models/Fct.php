...
/**
 * This is the model class for table "fct".
 *
 * @property integer $id
...
class Fct extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['type', 'ptname', 'disease', 'receive', 'ptcate', 'doctorapp', 'doctorapp2', 'doctorapp3', 'depart', 'officer'], 'string', 'max' => 50],
            [['pass', 'an', 'phone', 'lr07', 'lr08', 'lr09', 'lrl02', 'lrl03', 'lrl04', 'lrl05', 'lrl06', 'lrl10', 'lrl11', 'lrl12', 'lrl13', 'confirm', 'confirmfct'], 'string', 'max' => 10],
            [['colour', 'bp'], 'string', 'max' => 7],
            [['hn'], 'string', 'max' => 9],
            [['ptage'], 'string', 'max' => 3],
