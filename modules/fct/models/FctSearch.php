...
/**
 * FctSearch represents the model behind the search form about `app\modules\fct\models\Fct`.
 */
class FctSearch extends Fct
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['cid','type', 'pass', 'colour', 'hn', 'an', 'ptname', 'ptage', 'diage', 'pps', 'pain', 'painnote', 'cc', 'pi', 'bt', 'pr', 'rr', 'bp', 'drugallergy', 'admit', 'dc', 'or', 'ordate', 'disease', 'receive', 'address', 'ptcate', 'phone', 'hossub', 'tra', 'retng', 'retfo', 'colobag', 'lesion', 'lesioncare', 'recov', 'recovcare', 'oxygen', 'lr01', 'lr02', 'lr03', 'lr04', 'lr05', 'lr06', 'lr07', 'lr08', 'lr09', 'lr10', 'lrl01', 'lrl02', 'lrl03', 'lrl04', 'lrl05', 'lrl06', 'lrl07', 'lrl08', 'lr', 'lrl09', 'lrl10', 'lrl11', 'lrl12', 'lrl13', 'other', 'appdate', 'doctorapp', 'appdate2', 'doctorapp2', 'appdate3', 'doctorapp3', 'senddate', 'windpipe', 'insulin', 'equip', 'depart', 'hosin', 'officer', 'confirm', 'confirmfct'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'type', $this->type])
            ...
            ->andFilterWhere(['like', 'confirmfct', $this->confirmfct]);
