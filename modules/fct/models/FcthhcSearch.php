...
class FcthhcSearch extends Fcthhc
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'idfct', $this->idfct])
            ->andFilterWhere(['like', 'home', $this->home])
            ->andFilterWhere(['like', 'homept', $this->homept])
